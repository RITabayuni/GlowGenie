...
public class adaptersideprofil extends RecyclerView.Adapter<adaptersideprofil.ViewHolder> {

    List<String> abcd;
    List<Integer> abcdImage;
    LayoutInflater inflater;
    public adaptersideprofil (Context ctx, List<String> abcd, List<Integer> abcdImage){
        this.abcd = abcd;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.sideprofil2, parent, false);
